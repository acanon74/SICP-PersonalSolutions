...
(goto (label fib-loop))
afterfib-n-2
(restore n) ;Here is the change, by this point
;the stack contains val n-1 so instead of assigning
;val n-2 to n and the restoring val to val n-1, we can
;keep val as val n-2 and restore val n-1 directly into n.
(restore continue)
...
(define m (make-machine r o t))

(set-register-contents! m 'n '6)
(set-register-contents! m 'val '*error*)
