...
(define i '(controller
                          ...
                          (assign continue (label aftercar))
                          (goto (label loop))
 
                          aftercar
                          (restore tree)
                          (assign tree (op cdr) (reg tree))
                          (assign continue (label aftercdr))
                          (goto (label loop))
...
(define r '(continue tree val))
(define o (list (list '+ +) (list 'null? null?) 
                (list 'pair? pair?) (list 'car car) (list 'cdr cdr)))

(define m (make-machine r o i))

(set-register-contents! m 'tree '(a (b c (d)) (e f) g))
