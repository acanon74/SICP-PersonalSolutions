...
; Presumably we have data abstraction polynomial and created
; make-poly, variable nad term-list constructor and selectors

; We can add some means of combinations in the system like adding and
; multiplying
                    ...
                    (else
                      (adjoin-term
                        ...
                        (add-terms (rest-terms L1)
                                   (rest-terms L2)))))))))
  ; generic multiplication as well
